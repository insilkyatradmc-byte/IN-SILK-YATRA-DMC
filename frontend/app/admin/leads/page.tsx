      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6">
            {/* Leads List */}
            <div className="lg:col-span-2 bg-white border border-gray-200 overflow-hidden order-2 lg:order-1">
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white border border-gray-200 p-4 sm:p-6 lg:sticky lg:top-6">
                {selectedLead ? (
                  <div className="space-y-6">
                    <div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white transition-colors w-full justify-center rounded"
                      >
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white transition-colors w-full justify-center rounded"
                      >
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
