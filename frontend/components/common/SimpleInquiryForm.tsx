...
export default function SimpleInquiryForm() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-12">
        <div className="max-w-2xl w-full text-center space-y-6 animate-fadeIn">
          ...
          <h2 className="text-4xl font-serif text-gray-900">Thank You!</h2>
      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="text-center mb-8 space-y-3">
          ...
          <p className="text-base text-gray-600 max-w-xl mx-auto font-light">
            Share your travel details and our dedicated travel designer will craft a personalized Silk Road experience for you
          </p>
        </div>
